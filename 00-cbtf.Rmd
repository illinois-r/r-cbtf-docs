...
When downloading files from a question, the local default save location is: 

```bash
/home/<Your_NetID>/Downloads
```

**Note:** Both _Firefox_ and _Chrome_ will default to the above location.
...
Whereas when using the _Chrome_ web browser, the file will be silently saved
